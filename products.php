		...
		<!--content-->
			<div class="content">
				<div class="products-agileinfo">
						<h2 class="tittle">Focal Headphones</h2>
					<div class="container">
									...
									<ul class="tree-list-pad">
										<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Circumaurales</label>
											<ul>
													...
													<ul>
													<?php
														$result = mysqli_query($conn,"SELECT * FROM mydb.products WHERE marca=2 AND categoria=2;");
										...
										<li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1">Infraural</label>
											<ul>
													...
													<ul>
													<?php
														$result = mysqli_query($conn,"SELECT * FROM mydb.products WHERE marca=2 AND categoria=1;");
														while($row = mysqli_fetch_array($result)){ ?>
															<li> <a href="single.php?id=<?php echo $row['idProducts'] ?>"> <?php echo $row['nombre'] ?></a></li>
														<?php } ?>
													</ul>
									...
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
											<div class="product-tab">
												<?php
													$result = mysqli_query($conn,"SELECT * FROM mydb.products WHERE marca=2;");
													while($row = mysqli_fetch_array($result)){?>
