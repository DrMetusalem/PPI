		...
		<div class="main-agileits">
				<div class="form-w3agile form1">
					...
					<form action="insert.php" method="post">
						...
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text" value="Credit Card" name="Credit_Card" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Credit Card';}" required="">
							<div class="clearfix"></div>
						</div>
						<div class="key">
						...
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="password" value="" name="Confirm_Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
							<div class="clearfix"></div>
						</div>
