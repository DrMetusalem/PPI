	...
	<!--content-->
		<div class="content">
			...
			<div class="alert alert-success">
				...
				<a href="index.php">Continue Shopping
			</div></h1>
			<?php
                        
						//print_r($idUsuario);
						$idUsuario=mysqli_real_escape_string($conn,$_SESSION['user']);
                        $result = mysqli_query($conn,"SELECT * FROM mydb.users WHERE mail='$idUsuario' ;");
                            ...
                            <div class="cart-header">
                                ...
                                <div class="cart-sec simpleCart_shelfItem">
                                    ...
                                    <div class="cart-item-info">
                                        ...
                                        <h3><a href="#">Full Name of the buyer: <?php echo $row['nombre'] ?> <?php echo $row['apellido'] ?></a><span><strong>Address item will be sent:</strong> <?php echo $row['address'] ?> </span>
                                        <span><strong>Credit Card used to pay: </strong><?php echo $row['creditCard'] ?> </span></h3>
