		...
		<!--content-->
			<div class="content">
				<div class="products-agileinfo">
						<h2 class="tittle">Sennheiser Headphones</h2>
					<div class="container">
							...
							<div class="col-md-3 product-agileinfo-grid">
								<div class="categories">
									...
									<ul class="tree-list-pad">
										<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Circumaurales</label>
											<ul>
												
													<ul>
													<?php
														$result = mysqli_query($conn,"SELECT * FROM mydb.products WHERE marca=1 AND categoria=2;");
														while($row = mysqli_fetch_array($result)){ ?>
															<li> <a href="single.php?id=<?php echo $row['idProducts'] ?>"> <?php echo $row['nombre'] ?></a></li>
														<?php } ?>
										...
										<li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1">Infraural</label>
											<ul>
												
													<ul>
													<?php
														$result = mysqli_query($conn,"SELECT * FROM mydb.products WHERE marca=1 AND categoria=1;");
														while($row = mysqli_fetch_array($result)){ ?>
															<li> <a href="single.php?id=<?php echo $row['idProducts'] ?>"> <?php echo $row['nombre'] ?></a></li>
														<?php } ?>
													</ul>
									...
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
											<div class="product-tab">
												<?php
													$result = mysqli_query($conn,"SELECT * FROM mydb.products WHERE marca=1;");
													while($row = mysqli_fetch_array($result)){?>
														<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
															<div class="grid-arr">
																<div  class="grid-arrival">
																	<figure>		
																		<a  class="new-gri" data-toggle="modal" data-target="#myModal1">
																			<div class="grid-img">
																...
																<div class="women">
																	...
																	<h6><a href="single.php?id=<?php echo $row['idProducts'] ?>"><?php echo $row['nombre'] ?></a></h6>	
																	
																	<p ><em class="item_price">Precio: $<?php echo $row['precio'] ?></em></p>	
																	<a href="single.php?id=<?php echo $row['idProducts'] ?>" data-text="" class="label label-info">View More</a>
																</div>
															</div>
														</div>
												<?php	} ?>
