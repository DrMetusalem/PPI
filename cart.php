		...
		<div class="content">
			<div class="cart-items">
				<div class="container">
                            ...
                            <div class="cart-header">
                                ...
                                <div class="cart-sec simpleCart_shelfItem">
                                    ...
                                    <div class="cart-item-info">
                                        ...
                                        ?>
                                        <h3><a href="#"> <?php echo $rowimg['nombre'] ?></a><span>Brand: <?php echo $rowBrand['nombre'] ?> </span></h3>
                                        <ul class="qty">
                                            <?php
                                               $auxDel=$row['idCart'];
                                            ?>
                                            ...
                                            <br><br>
                                            <h2><a href="removeCart.php?idProd=<?php echo $auxDel ?>"> <span class="label label-danger">Delete Product</span></a></h2>
                                        </ul>
                                            <div class="delivery">
                     ...
                     <?php	} ?>
                     <div class="alert alert-info"><strong>Total: $</strong><?php echo $_SESSION['total']?>usd  </div>
                     <h2><a href="addOrder.php"> <span class="label label-success">Place Order</span></a></h2>
